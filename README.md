...
For reading inventories, Supervisory use standard NeoForge capabilities, meaning it should be compatible with all mods. Additionally, explicit compatibility with CC:Tweaked is included, PLCs can use all CC:Tweaked peripherals, including those added by other mods, via the [`Interop`](https://bt7s7k7.github.io/Supervisory/Interop.html#interop) API.
...
This system means that in the first iteration of the reactive scope in the receiving device, the value of the resource will not be known, because the subscription was just created. The resource will have a value of [`void`](https://bt7s7k7.github.io/TreeBurst/index.html#void). That is what the [`ReactiveScope.awaitReady`](https://bt7s7k7.github.io/Supervisory/ReactiveScope.html#reactivescope-awaitready) method is used for; if any of the resources used by the scope are not yet available, it will abort the execution of the scope, until their value becomes known. 
...
For redstone, you can use the [`Redstone`](https://bt7s7k7.github.io/Supervisory/Redstone.html#redstone) API, which allows you to read and write redstone signals.
...
For more complex interaction, sockets are used. The PLC must explicitly connect to a socket which provides a resource. This proces takes some time or there may not be anything to connect to at all. For example when using the [`Storage`](https://bt7s7k7.github.io/Supervisory/Storage.html#storage) API, when an inventory is not attached, the connection will not be established and the value of the resource will be [`void`](https://bt7s7k7.github.io/TreeBurst/index.html#void). Likewise for the [`Sensor`](https://bt7s7k7.github.io/Supervisory/Sensor.html#sensor) API, when there isn't a block attached, it will also return [`void`](https://bt7s7k7.github.io/TreeBurst/index.html#void). Establishing a connection also takes a tick, so the first time connection is used, it will be [`void`](https://bt7s7k7.github.io/TreeBurst/index.html#void). To handle this, use the [`ReactiveScope.awaitReady`](https://bt7s7k7.github.io/Supervisory/ReactiveScope.html#reactivescope-awaitready) method, same as with value resources.
