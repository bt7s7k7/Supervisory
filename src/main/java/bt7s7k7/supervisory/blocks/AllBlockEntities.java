...
public class AllBlockEntities {
	public static final BlockEntityEntry<RemoteTerminalUnitBlockEntity> REMOTE_TERMINAL_UNIT = Supervisory.REGISTRATE
			.blockEntity("remote_terminal_unit", RemoteTerminalUnitBlockEntity::new)
