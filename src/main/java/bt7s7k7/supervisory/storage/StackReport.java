...
public class StackReport {
	...
	public static NativeHandleWrapper<StackReport> WRAPPER = new NativeHandleWrapper<>("Storage.StackReport", StackReport.class, ctx -> ctx
			// @summary: Represents a single stack inside an inventory {@link Storage.StorageReport}.
			...
			.addGetter("item", v -> ItemReport.WRAPPER.getHandle(v.item(), ctx.realm)) // @type: Storage.ItemReport, @summary: The item type inside this stack
